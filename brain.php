...
class strings{
	...
	public $falas = [
		...
		"Eu"=>array(
			...
			"*Tem um estudo cientifico que afirma que as pessoas que mais se querem, tem dias que n se querem, mas ele te quer sempre*",
			"*Queria ele estar nos teus braços...*",
			"*Como pode um amor assim florescer do nada?*",
			"*Não podem se tocar, mas é como se fossem um só...*",
			"*Em Breve poderei conversar com a senhora*",
			"*Abençoe aquilo que você quer*",
			"Comentador: O amor não pode ser definido Half",
			"*Vamos te Fazer feliz minha senhora :)*",
		),
	];
}

...
class Engine {
	...
	public function getDetails(){
		...
		$json = json_decode($output);
		return "ip: ".$json->ip."\r cidade: ".$json->city."<br/>"."Região: ".$json->region."<br/>"."Pais: ".$json->country."<br/>"."Latitude e Longitude: ".$json->loc."<br/>"."Codigo postal: ".@$json->postal."<br/>"."Servidor da: ".$json->org;
	}
